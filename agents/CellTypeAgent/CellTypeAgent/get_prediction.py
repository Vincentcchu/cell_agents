...
def create_predicition_prompt(dataset_name, number_of_candidates=3, data_dir='data/GPTCellType/datasets', data_info=data_info,
                              index_to_predict=None, poor_performance_model=False, max_markers=None, prompt_suffix="", species=None):
...
if __name__ == "__main__":
    ...
    for dataset_name in datasets:
        ...
        data, log_path = get_prediction(model, dataset_name, poor_performance_model=False, max_markers=max_markers,
                                         number_of_candidates=top_n, data_dir=data_dir, log_dir=log_dir, species='human')
